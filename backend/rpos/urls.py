...
urlpatterns = [
    ...
    path('api/v1/CategoryCreate', views.CategoryCreateView.as_view(), name='set_post_Category'),
    ...
    path('api/v1/ProductCreate', views.ProductCreateView.as_view(), name='set_post_Product'),
    ...
    path('api/v1/TableCreate', views.TableCreateView.as_view(), name='set_post_Table'),
    ...
    path('api/v1/OrderCreate', views.OrderCreateView.as_view(), name='set_post_Order'),
